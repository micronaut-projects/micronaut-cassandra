...
[source,groovy]
----
include::cassandra/src/test/groovy/io/micronaut/configuration/cassandra/CassandraConfigurationSpec.groovy[tags=single, indent=0]
----
...
[source,groovy]
----
include::cassandra/src/test/groovy/io/micronaut/configuration/cassandra/CassandraConfigurationSpec.groovy[tags=multiple, indent=0]
----
